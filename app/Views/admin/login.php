            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                <div class="brand-logo">
                  <img src="<?=base_url('static/admin/');?>assets/images/logo.svg">
                </div>
...
<?php endif; ?>
                ...
                <form class="pt-3" method="post" id="login-form">
                  ...
                  <div class="mt-3 d-grid gap-2">
                    <button type="submit" class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn" onclick="loginCheck()">SIGN IN</button>
                  </div>
    ...
    <!-- inject:js -->
    <script src="<?=base_url('static/admin/');?>assets/js/off-canvas.js"></script>
    <script src="<?=base_url('static/admin/');?>assets/js/misc.js"></script>
    <script src="<?=base_url('static/admin/');?>assets/js/settings.js"></script>
    <script src="<?=base_url('static/admin/');?>assets/js/todolist.js"></script>
    <script src="<?=base_url('static/admin/');?>assets/js/jquery.cookie.js"></script>
    <!-- endinject -->
