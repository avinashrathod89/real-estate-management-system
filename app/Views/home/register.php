					...
					<div class="form-inner-cont">
						...
						<form method="post" class="main-input">
							<div class="top-inputs d-grid">
								<input type="text" placeholder="Name" name="fullname" id="w3lName" required="">
								<input type="email" name="email" placeholder="Email" id="w3lSender" required="">
							</div>
							<input type="text" placeholder="Phone Number" name="mobile" id="w3lName" required="">
							<input type="text" placeholder="Password" name="password" id="w3lName" required="">
